...
= 2.6.1 =
* [Fixed] 設定画面の「同ページへのリンク」の表示項目を一部修正しました。
...
* [Modified] 設定画面の「外部リンク」「内部リンク」の項目を追加しました。[Pz3]
...
* [Added] 編集画面のサムネイル画像とサイトアイコン画像を解除出来るように変更しました。
...
* [Added] 設定画面のタブの上で右クリックしながらホイールを回すと前/次のタブを選択できるようにしました。
* [Added] 設定画面のテキストボックスやコンボボックスで右クリック＋ホイールで選択肢を増減できるようにしました。
* [Removed] 設定画面の「配置」タブから「BLOCKQUOTEで囲む」を削除しました。「全体をタグで囲む」で同じことが出来るようになりました。[Pz3]
